                    ...
                    <div className="all-leng py-4 " ref={ref} >
                        ...
                        {leng.map((e , i) => {
                            return (
                                ...
                                : 
                                (<div direction = {e.dir} short-name-leng = {e.short}  onClick={(item) => handleChangeLueng(item.target)} key={i} className="leng cursor-pointer flex items-center text-xs mt-2 group hover:text-mainColor z-20"> 
